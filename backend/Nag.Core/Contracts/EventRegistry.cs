...
public static class EventRegistry
{
    public static readonly IReadOnlyDictionary<string, Type> ByName = new Dictionary<string, Type>
    {
        ...
        [nameof(HabitArchived)] = typeof(HabitArchived),
        [nameof(HabitUnarchived)] = typeof(HabitUnarchived),
        [nameof(HabitPaused)] = typeof(HabitPaused),
        [nameof(HabitUnpaused)] = typeof(HabitUnpaused),
