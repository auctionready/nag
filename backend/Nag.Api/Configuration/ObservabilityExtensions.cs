...
{
    public static WebApplicationBuilder AddNagSentry(this WebApplicationBuilder builder)
    {
    ...
    public static WebApplicationBuilder AddNagSerilog(this WebApplicationBuilder builder)
    {
